...
for z in range(dims[2]):
    for y in range(dims[1]):
        for x in range(dims[0]):
            ...
            # . . . . .
            # . . . . .
            if GetArrValue(distArr,(x,y,z)) != obstacle_num:        #add   
...
for z in range(dims[2]):
    for y in range(dims[1]):
        for x in range(dims[0]):            
            if GetArrValue(distArr, (x, y, z)) != 1:
                  SetArrValue(distArr, (x, y, z), abs(height - GetArrValue(distArr, (x, y, z)))) # distance from the surface whose height=100
            else:
                  SetArrValue(distArr, (x, y, z), 10000) # obstacle=10000
